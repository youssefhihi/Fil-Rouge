...
<x-success-message/>   
  ...
  <div class="w-full relative flex items-center justify-center">
    ...
    <form action="{{route('suscriber.store')}}" method="post" class="bg-black bg-opacity-35 rounded-xl md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-10">
      @csrf
      @method('POST')
